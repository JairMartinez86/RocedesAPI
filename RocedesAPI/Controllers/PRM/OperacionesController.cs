                    ...
                    using (AuditoriaEntities _Conexion = new AuditoriaEntities())
                    {
                        ...
                        if (Registro == null)
                        {
                            ...
                            Registro = new MethodAnalysis
                            {
                                ...
                                Operacion = Datos1.Operacion.ToUpper().TrimStart().TrimEnd(),
                                Rate = Datos1.Rate,
                                JornadaLaboral = Datos1.JornadaLaboral,
                                IdManufacturing = Datos1.IdManufacturing,
                                Manufacturing = Datos1.Manufacturing.ToUpper().TrimStart().TrimEnd(),
                                IdProducto = Datos1.IdProducto,
                                Producto = Datos1.Producto.ToUpper().TrimStart().TrimEnd(),
                                IdFamily = Datos1.IdFamily,
                                Family = Datos1.Family.ToUpper().TrimStart().TrimEnd(),
                                IdSecuence = Datos1.IdSecuence,
                                Secuence = Datos1.Secuence,
                                IdDataMachine = Datos1.IdDataMachine,
                                DataMachine = Datos1.DataMachine.ToUpper().TrimStart().TrimEnd(),
                                Delay = Datos1.Delay,
                                Personal = Datos1.Personal,
                                Fatigue = Datos1.Fatigue,
                                IdStitchType = Datos1.IdStitchType,
                                TypeStitch = Datos1.TypeStitch.ToUpper().TrimStart().TrimEnd(),
                                IdNeedle = Datos1.IdNeedle,
                                NeedleType = Datos1.NeedleType.ToUpper().TrimStart().TrimEnd(),
                                IdRpm = Datos1.IdRpm,
                                Rpm = Datos1.Rpm,
                                IdStitchInch = Datos1.IdStitchInch,
                                StitchInch = Datos1.StitchInch,
                                IdTela = Datos1.IdTela,
                                Tela = Datos1.Tela.ToUpper().TrimStart().TrimEnd(),
                                IdOunce = Datos1.IdOunce,
                                Ounce = Datos1.Ounce,
                                IdCaliber = Datos1.IdCaliber,
                                Caliber = Datos1.Caliber.ToUpper().TrimStart().TrimEnd(),
                                IdFeedDog = Datos1.IdFeedDog,
                                FeedDog = Datos1.FeedDog.ToUpper().TrimStart().TrimEnd(),
                                IdPresserFoot = Datos1.IdPresserFoot,
                                PresserFoot = Datos1.PresserFoot.ToUpper().TrimStart().TrimEnd(),
                                IdFolder = Datos1.IdFolder,
                                Folder = Datos1.Folder.ToUpper().TrimEnd(),
                                MateriaPrima_1 = Datos1.MateriaPrima_1.ToUpper().TrimStart().TrimEnd(),
                                MateriaPrima_2 = Datos1.MateriaPrima_2.ToUpper().TrimStart().TrimEnd(),
                                MateriaPrima_3 = Datos1.MateriaPrima_3.ToUpper().TrimStart().TrimEnd(),
                                FechaRegistro = Fecha,
